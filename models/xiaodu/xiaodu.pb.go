...
type BidRequest_Imp struct {
	...
	Slottype         *BidRequest_Imp_SlotType `protobuf:"varint,15,opt,name=slottype,enum=BidRequest_Imp_SlotType" json:"slottype,omitempty"`
	XXX_unrecognized []byte                   `json:"-"`
}
...
type BidRequest_Imp_Banner struct {
	...
	// Type of current adslot.
	Slottype *BidRequest_Imp_Banner_SlotType `protobuf:"varint,15,opt,name=slottype,enum=BidRequest_Imp_Banner_SlotType" json:"slottype,omitempty"`
...
type BidRequest_Imp_Video struct {
	...
	Linearity *BidRequest_Imp_Video_VideoLinearity `protobuf:"varint,2,opt,name=linearity,enum=BidRequest_Imp_Video_VideoLinearity" json:"linearity,omitempty"`
	...
	// Type of current adslot.
	Slottype         *BidRequest_Imp_Video_SlotType `protobuf:"varint,14,opt,name=slottype,enum=BidRequest_Imp_Video_SlotType" json:"slottype,omitempty"`
	XXX_unrecognized []byte                         `json:"-"`
}
...
type BidRequest_Imp_Native_Asset_Image struct {
	...
	Type *BidRequest_Imp_Native_Asset_Image_ImageAssetType `protobuf:"varint,1,opt,name=type,enum=BidRequest_Imp_Native_Asset_Image_ImageAssetType" json:"type,omitempty"`
...
type BidRequest_Imp_Native_Asset_Data struct {
	...
	Type *BidRequest_Imp_Native_Asset_Data_DataAssetType `protobuf:"varint,1,req,name=type,enum=BidRequest_Imp_Native_Asset_Data_DataAssetType" json:"type,omitempty"`
...
type BidRequest_Device struct {
	...
	Connectiontype *BidRequest_Device_ConnectionType `protobuf:"varint,25,opt,name=connectiontype,enum=BidRequest_Device_ConnectionType" json:"connectiontype,omitempty"`
	// The general type of device.
	Devicetype       *BidRequest_Device_DeviceType `protobuf:"varint,26,opt,name=devicetype,enum=BidRequest_Device_DeviceType" json:"devicetype,omitempty"`
	XXX_unrecognized []byte                        `json:"-"`
}
...
type BidRequest_Device_Geo struct {
	...
	Type             *BidRequest_Device_Geo_LocationType `protobuf:"varint,9,opt,name=type,enum=BidRequest_Device_Geo_LocationType" json:"type,omitempty"`
	XXX_unrecognized []byte                              `json:"-"`
}
...
func init() {
	proto.RegisterEnum("BidRequest_Imp_SlotType", BidRequest_Imp_SlotType_name, BidRequest_Imp_SlotType_value)
	proto.RegisterEnum("BidRequest_Imp_BidInfo_BidType", BidRequest_Imp_BidInfo_BidType_name, BidRequest_Imp_BidInfo_BidType_value)
	proto.RegisterEnum("BidRequest_Imp_Banner_SlotType", BidRequest_Imp_Banner_SlotType_name, BidRequest_Imp_Banner_SlotType_value)
	proto.RegisterEnum("BidRequest_Imp_Video_SlotType", BidRequest_Imp_Video_SlotType_name, BidRequest_Imp_Video_SlotType_value)
	proto.RegisterEnum("BidRequest_Imp_Video_VideoLinearity", BidRequest_Imp_Video_VideoLinearity_name, BidRequest_Imp_Video_VideoLinearity_value)
	proto.RegisterEnum("BidRequest_Imp_Native_Asset_Image_ImageAssetType", BidRequest_Imp_Native_Asset_Image_ImageAssetType_name, BidRequest_Imp_Native_Asset_Image_ImageAssetType_value)
	proto.RegisterEnum("BidRequest_Imp_Native_Asset_Data_DataAssetType", BidRequest_Imp_Native_Asset_Data_DataAssetType_name, BidRequest_Imp_Native_Asset_Data_DataAssetType_value)
	...
	proto.RegisterEnum("BidRequest_Device_Geo_LocationType", BidRequest_Device_Geo_LocationType_name, BidRequest_Device_Geo_LocationType_value)
}
